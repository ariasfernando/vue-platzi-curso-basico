<template>
  <module-container :component="component" @select-component="selectComponentHandler">
      <a
        :data-contenteditable-href="component.button.attribute.href || '#peperoni-studio'"
...
<script>
  import TinyMCE from 'stensul/components/admin/elements/TinyMce.vue';
  import ComponentToolbar from 'stensul/components/admin/elements/ComponentToolbar.vue';
  ...
  import MontedElementMixin from 'stensul/components/admin/mixins/MontedElementMixin.js';
