    ...
    <div class="section-box-header section-canvas-title">
      <div class="row">
        ...
        <div class="col-xs-7 col-md-5 col-lg-5 text-right pull-right" id="section-canvas-buttons-col">
          ...
          <a class="btn campaign-continue beta-btn-primary" :class="{ 'button-disabled': errors.length } " v-if="campaign.campaign_data.can_be_processed && !campaign.campaign_data.template" @click="complete"
            >
            Complete
