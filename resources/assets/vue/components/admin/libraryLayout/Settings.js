export default [
  {
    ...
    settings: [
      ...
      },
      {
        ...
        type: 'stui-toggle-button',
        settingSlot: 'setting-right',
        label: 'Enable prepend/append body',
      },
      {
        name: 'prependHtml',
        aclName: 'library-advance-settings',
        ...
        type: 'stui-input-text',
        propType: 'textarea',
          placeholder: 'Add the default prepend to body...',
        label: 'Default Prepend to body',
        settingSlot: 'setting-bottom',
        dependsOn: [{ path: 'library.config.insertBody' }],
      }, {
        name: 'appendHtml',
        aclName: 'library-advance-settings',
        path: 'library.config',
        type: 'stui-input-text',
        propType: 'textarea',
        placeholder: 'Add the default append to body...',
        label: 'Default Append to body',
        settingSlot: 'setting-bottom',
        dependsOn: [{ path: 'library.config.insertBody' }],
      },
    ],
