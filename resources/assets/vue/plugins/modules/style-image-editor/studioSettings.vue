<template>
  <div>
    ...
    <template
      v-if="plugin.enabled"
      v-for="(option, name) in plugin.config"
      >
      <settings-container
        :label="option.label"
        :key="name"
      ...
      <template
        v-if="option.value && option.config"
        v-for="(subopt, subname) in option.config"
        >
        <settings-container
          :label="subopt.label"
          :key="subname"
        ...
        <template
          v-if="subopt.value && subopt.config"
          v-for="(interop, intername) in subopt.config"
          >
          <settings-container
            :label="interop.label"
            :key="intername"
            ...
            <template
              ...
              <el-input
                size="mini"
                v-if="interop.type === 'text'"
                :value="interop.value"
                @change="(newValue) => updateInterField(newValue, name, subname, subninternameame)"
                ></el-input>
              <el-input-number
