        ...
        <div class="section-box-header section-canvas-title">
            <div class="row">
                ...
                <div :class="'col-xs-8 col-md-7 col-lg-' + buttonsCols + ' text-right'" id="section-canvas-buttons-col">
                    ...
                    <button class="btn btn-default save-as-draft" :class="hiddenClass()" v-if="!params.template" @click="saveCampaign">Save as Draft</button>

                    <button class="btn btn-default save-as-template" :class="hiddenClass()" v-if="!params.processed && params.campaign_data.library_config.enable_templating">Save as Template</button>

                    <a class="btn btn-continue campaign-continue" :class="hiddenClass()" v-if="!params.template" href="#">Complete<i class="glyphicon glyphicon-triangle-right"></i></a>
                </div>
            </div>
        </div>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="center" bgcolor="#FFFFFF" style="vertical-align:top;">
                        <table id="emailCanvas" class="email-canvas wrapper-table" :width="params.campaign_data.library_config.template_width" cellspacing="0" cellpadding="0" border="0">
                            <tbody>
