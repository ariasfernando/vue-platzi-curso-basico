<template>
  <table width="100%" cellspacing="0" cellpadding="0">
    <tr v-if="module.columns.length > 1">
      <th class="st-col" v-for="(column, columnId) in module.columns" :width="column.style.default.width"
          :style="column.style.default">
    ...
    <tr v-else>
      <td v-for="(column, columnId) in module.columns" :width="column.style.default.width"
          :style="column.style.default">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
          <tr v-for="(component, componentId) in column.components">
            <td>
