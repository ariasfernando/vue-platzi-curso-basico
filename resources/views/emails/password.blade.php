...
We received a request to reset the password for your stensul account (<a href="{{ url('/') }}" target="_blank">{{ url('/') }}</a>). <br/>

To reset your password, please go to:<br />
<a href="{{ url('password/reset/'.$token) }}" target="_blank">{{ url('password/reset/'.$token) }}</a><br/><br/>

This link expires in one hour. <br/>
...
The link in this email will start with "https://” and contain “stensul.com” <br/>

stensul, Inc. | 150 West 25th Street, 3rd Floor, New York, NY 10001