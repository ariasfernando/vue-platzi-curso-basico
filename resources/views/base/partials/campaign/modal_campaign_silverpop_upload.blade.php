<div id="modal-campaign-upload-silverpop" class="modal fade display-code-modal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4>Upload to {{ $app_config['api']['silverpop']['title'] }}</h4>
                </div>
                <div class="modal-body">
                    <div class="response-message-success alert alert-success" style="display:none;">
                        Email successfully uploaded to {{ $app_config['api']['silverpop']['title'] }}. <a href="{{ url('/') }}" class="allow-exit">View dashboard</a>.
                    </div>
                    ...
                    <form name="upload-api-form" class="upload-api-form">
                        ...
                        <input type="hidden" name="api_driver" value="{{ $app_config['api']['silverpop']['class'] }}" class="api_driver" />
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-upload-submit" data-api-driver="silverpop">Upload</button>
                </div>
            </div>
        </div>
</div>