                ...
                <td align="center" valign="top" style="font-size:0; padding: 10px 0;">
                    ...
                    <div style="display:inline-block; margin: 0 -2px; max-width: 440px; min-width:320px; vertical-align:top;" class="stack-column">
                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                            <tbody><tr>
                                <td dir="ltr" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 10px; text-align: left;" class="center-on-narrow">
                                    ...
                                    {{-- Button : Begin --}}
                                    <table cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" align="left" style="margin-top: 10px !important; display:{{ $buttonData['visibility'] == 'false' ? 'none' : 'table' }} !important">
                                        <tbody><tr>
                                            <td class="st-btn button-td"
                                                ...
                                                <a  href="{{ $buttonData['destination_url'] or '#' }}" class="button-a st-without-event st-cta-button"
                                                    ...
                                                    <span contenteditable="true" style="color: {{ $buttonData['font_color'] or $module_params['button']['font_colors']['default'] }}"
                                                          truncate="50" class="st-save-only-text st-content-editable-single-line">{{ $buttonData['text'] or "CTA Button" }}</span>
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody></table>
                    ...
                    <div style="display:inline-block; margin: 0 -2px; max-width: 220px; min-width:160px; vertical-align:top; width:100%; padding-top: 10px" class="stack-column">
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tbody><tr>
                                <td dir="ltr" style="padding: 10px 0 10px 10px;">
