<?php
	...
	if( isset($module_params['data']['text4']) && !empty($module_params['data']['text4']) ){
		$text2 = $module_params['data']['text4'];
	}
    ...
    if( isset($module_params['data']['text5']) && !empty($module_params['data']['text5']) ){
        $buttonData2['text'] = $module_params['data']['text5'];
    }
    if( isset($module_params['data']['link2']) && !empty($module_params['data']['link2']) ){
        $buttonData2['destination_url'] = $module_params['data']['link2'];
    }

?>
{{-- Three Column Media With Text: Start --}}
		...
		<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" style="max-width:660px;">
			<tbody><tr>
				<td align="center" valign="top" style="font-size:0; padding: 10px 0;">
					...
					<div style="display:inline-block; margin: 0 -2px; width:100%; min-width:200px; max-width:220px; vertical-align:top;" class="stack-column">
						<table cellspacing="0" cellpadding="0" border="0" width="100%">
							<tbody><tr>
								<td style="padding: 10px 10px;">
									@include('base.modules.three_column_media_with_text.column', [
										'image' => $image0,
										'image_key' => 'image0',
										'text' => $text0,
...
{{-- Three Column Media With Text: End --}}
